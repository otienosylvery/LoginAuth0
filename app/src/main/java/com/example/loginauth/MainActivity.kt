...
class MainActivity : AppCompatActivity() {
    ...
    private fun getUserMetadata(): View.OnClickListener? {

        // Guard against getting the metadata when no user is logged in
        if (cachedCredentials == null) {
            Toast.makeText(applicationContext, "You are doing this in the right order!", Toast.LENGTH_LONG).show();
        //return
        }
    ...
    private fun setUserMetadata(): View.OnClickListener? {
        // Guard against getting the metadata when no user is logged in
        if (cachedCredentials == null) {
            Toast.makeText(applicationContext, "You are doing this in the right order!", Toast.LENGTH_LONG).show();
        //return
